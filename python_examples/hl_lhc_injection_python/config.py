configuration = {
    ...
    'optics_file'              : '/afs/cern.ch/eng/lhc/optics/HLLHCV1.5/ramp/opt_inj_6000_thin.madx', #15 cm
    ...
    # Beam parameters
    'beam_norm_emit_x'     : 2.3,          # [um]
    'beam_norm_emit_y'     : 2.3,          # [um]
    'beam_sigt'            : 0.083,        # [m]
    'beam_sige'            : 3.3e-4,       # [-]
    'beam_npart'           : 2.3e11,       # [-]
    'beam_energy_tot'      : 450,         # [GeV]
    ...
    'match_q_dq_with_bb'        : True,            # should be off at collision
